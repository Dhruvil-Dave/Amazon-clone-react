    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>
                    By Signing you agree to the terms and conditions of use.
                </p>
